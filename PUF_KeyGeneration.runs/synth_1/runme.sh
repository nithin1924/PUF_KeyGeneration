...
HD_PWD='C:/Users/nithi/PUF_KeyGeneration/PUF_KeyGeneration.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Main_Puf.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Main_Puf.tcl
