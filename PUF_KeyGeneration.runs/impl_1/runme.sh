...
HD_PWD='C:/Users/nithi/PUF_KeyGeneration/PUF_KeyGeneration.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Main_Puf.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Main_Puf.tcl -notrace
